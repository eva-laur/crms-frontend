...
const allowedOrigins = (process.env.CORS_ORIGINS || "https://crms-backend-qjwk7hu4n-evalaure014-gmailcoms-projects.vercel.app/,http://localhost:8081,http://localhost:5000")
  .split(",")
  .map((o) => o.trim())
  .filter(Boolean);
